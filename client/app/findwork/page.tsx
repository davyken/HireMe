    ...
    <main>
      ...
      <div className="relative px-4 sm:px-8 md:px-16 bg-[#D7DEDC] overflow-hidden mt-20">
        ...
        <Image
          ...
          width={200}
          height={500}
          className="hidden md:block clip-path w-[10rem] lg:w-[15rem] absolute z-0 top-[0] right-[5rem] lg:right-[10rem] h-full object-cover"
        />
        ...
        <Image
          ...
          width={200}
          height={500}
          className="hidden lg:block clip-path-2 rotate-6 w-[10rem] lg:w-[15rem] absolute z-0 top-[0] right-[20rem] lg:right-[32rem] h-full object-cover"
        />
      </div>

      <div className="w-[95%] sm:w-[90%] mx-auto mb-14">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-black py-8">Recent Jobs</h2>

          <button
            onClick={toggleGridColumns}
            className="flex items-center gap-4 border border-gray-400 px-4 sm:px-8 py-2 rounded-full font-medium"
          >
            <span>
              {columns === 3
                ? "Grid View"
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            {jobs.length > 0 ? (
              ...
              <div className="mt-1 flex items-center col-span-full">
